...
Nan et al.~\cite{hunanpaper,hunanthesis} conducted a series of controlled field experiments to study the interaction among individual participants and their movement in certain scenarios. In this section, the experimental setup used by Nan in his thesis is first reproduced. Following this, the results obtained by him are presented and compared against the results produced by RVO2 agents using Information Based Perception.
...
\subsubsection{Metrics Used} % (fold)
...
%         \includegraphics[width=\textwidth]{CategoriesPicture}
%     \end{center}
%     \caption{An overview of all the metrics that were used to measure the trajectories of participants in the video.}
%     \label{% \begin{figure}[!tbph]
%     \begin{center}
%         \includegraphics[width=\textwidth]{CategoriesPicture}
%     \end{center}
%     \caption{The trajectories of participants can be grouped into 3 categories}
...
\begin{figure}[!tb]
  \centering
  \subfloat[Speed against Time]{\label{fig:SpeedIBPPlot}\includegraphics[width=3in]{SpeedPlot.png}}
  \hspace{1pt}
% \\
   \subfloat[Distance against Time]{\label{fig:DistanceIBPPlot}\includegraphics[width=3in]{DistancePlot.png}}
   % \\
   % \subfloat[Curvature against Time]{\label{fig:CurvatureIBPPlot}\includegraphics[scale=0.05]{CurvaturePlot.png}}
   % \hspace{3pt}
    % \subfloat[Deviation against Time]{\label{fig:DeviationIBPPlot}\includegraphics[scale=0.05]{DeviationPlot.png}}
