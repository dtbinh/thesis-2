...
Hu et al.~\cite{hunanpaper,hunanThesis} conducted a series of controlled field experiments to study the interaction among individual participants and their movement in certain scenarios. In this section, the experimental setup used by Hu in his thesis is first reproduced. Following this, the results obtained are presented and compared against the results produced by RVO2 agents using Information Based Perception.
...
\begin{figure}[!tbhp]
    \begin{center}
        \includegraphics[width=\textwidth]{schematic_setup.pdf}
    \end{center}
...
\begin{figure}[!tbhp]
    \begin{center}
        \includegraphics[]{detailed_setup.pdf}
    \end{center}
...
\begin{figure}[!tbhp]
    \begin{center}
        \includegraphics[scale=0.75]{DataExtractionProcess.pdf}
    \end{center}
...
\begin{figure}[!tbhp]
    \centering
   		\subfloat[Step 1]{\includegraphics[width=7.5cm,height=4cm]{extract_1}}
  		\hspace{1pt}
    	\subfloat[Step 2]{\includegraphics[width=7.5cm,height=4cm]{extract_2}}
  		\\
  		\subfloat[Step 3]{\includegraphics[width=7.5cm,height=4cm]{extract_3}}
  		\hspace{1pt}
  		\subfloat[Step 4]{\includegraphics[width=7.5cm,height=4cm]{extract_4}}
  		\\
  		\subfloat[Step 5]{\includegraphics[width=7.5cm,height=4cm]{extract_5}}
  		\hspace{1pt}
  		\subfloat[Step 6]{\includegraphics[width=7.5cm,height=4cm]{extract_6}}
...
\begin{figure}[!tbph]
    \begin{center}
        \includegraphics[width=\textwidth]{CategoriesPicture}
    \end{center}
...
\begin{figure}[!tbph]
    \begin{center}
        \includegraphics[width=\textwidth]{metricsUsedHuNan}
    \end{center}
...
\begin{figure}[!tbph]
    \begin{center}
        \includegraphics[width=\textwidth]{expSimulationSetup}
    \end{center}
...
%     \begin{adjustbox}{width=\textwidth,center}
    % \begin{adjustbox}{center}
        \begin{tabular}{p{1.25in}   p{0.75in}   p{0.75in} p{0.75in} p{0.75in}}
            \hline
            \multicolumn{1}{c}{} &\multicolumn{1}{c}{} &\multicolumn{1}{c}{Category 1 (\textbf{55\%})} &\multicolumn{1}{c}{Category 2 (40\%)}  &\multicolumn{1}{c}{Category 3 (5\%)} \\
            \hline
            \hline
            \multirow{3}{1.5in}{Maximum \\ Deviation} & \multicolumn{1}{l}{D1} & \multicolumn{1}{l}{0.0785} & \multicolumn{1}{l}{0.320723} & \multicolumn{1}{l}{0.241166}
            \\%\cline{2-5}
                                    & \multicolumn{1}{l}{D2} & \multicolumn{1}{l}{\textbf{0.8720}}& \multicolumn{1}{l}{\textbf{0.868398}}& \multicolumn{1}{l}{0.320865}
            \\%\cline{2-5}
                                    & \multicolumn{1}{l}{D3} & \multicolumn{1}{l}{0.2656}& \multicolumn{1}{l}{0.18667}& \multicolumn{1}{l}{\textbf{0.657496}}
            \\%\cline{2-5}

            \hline

            \multirow{3}{1.5in}{Trajectory Length} & \multicolumn{1}{l}{L1} & \multicolumn{1}{l}{10.0542} & \multicolumn{1}{l}{10.12006} & \multicolumn{1}{l}{10.15071}
            \\%\cline{2-5}
                                    & \multicolumn{1}{l}{L2} & \multicolumn{1}{l}{\textbf{10.238}}& \multicolumn{1}{l}{\textbf{10.27922}}& \multicolumn{1}{l}{10.15928}
            \\%\cline{2-5}
                                    & \multicolumn{1}{l}{L3} & \multicolumn{1}{l}{10.1126} & \multicolumn{1}{l}{10.0789} & \multicolumn{1}{l}{\textbf{10.18924}}
            \\%\cline{2-5}
...
%     \end{adjustbox}
%     \vspace{ - 05 mm}
    \caption{Maximum deviation and path length according to experiments conducted Hu~\cite{hunanThesis}. Category 1 refers to the movement of Agent 2 to the left of the group, category 2 to the movement of Agent 2 to the right of the group and category 3 to the movement of agent 2 through the middle of the oncoming group.}
...
%     \begin{adjustbox}{width=\textwidth,center}
    % \begin{adjustbox}{center}
        \begin{tabular}{p{1.5in}   p{0.75in}   p{0.75in}}
            \hline
            % \multicolumn{1}{c}{} &\multicolumn{1}{c}{} &\multicolumn{1}{c}{Category 1}  \\
            % \hline
            % \hline
...
\begin{figure}[!tb]
  \centering
  \subfloat[Agent 2]{\includegraphics[width=0.9\textwidth]{SpeedPlot-agent2.png}}
   \\
   \subfloat[Agent 1]{\includegraphics[width=0.9\textwidth]{SpeedPlot-agent1.png}}
   \\
    \subfloat[Agent 3]{\includegraphics[width=0.9\textwidth]{SpeedPlot-agent3.png}}
...
\begin{figure}[!tb]
  \centering
  \subfloat[Experiment]{\includegraphics[width=4in]{DistancePlot-RVO2-IBP.png}}
  \\
   \subfloat[IBP-RVO2]{\label{fig:DistanceIBPPlot-IBP}\includegraphics[width=4in]{DistancePlot-RVO2-IBP.png}}
   \\
   \subfloat[RVO2]{\label{fig:DistanceIBPPlot-RVO2}\includegraphics[width=4in]{DistancePlot-RVO2.png}}
   \\
    \subfloat[Social Force]{\label{fig:DistanceIBPPlot-SF}\includegraphics[width=4in]{DistancePlot-SocialForce.png}}
