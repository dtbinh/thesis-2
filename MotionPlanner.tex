...
\begin{figure}[htbp]
\includegraphics[width=3.4in]{ExperimentSetup}
...
\begin{figure}[h]
\begin{center}
\includegraphics[scale=0.5]{Zoning}
...
% Evacuation Time Distribution
\begin{figure*}[htbp]
\subfloat[]{\includegraphics[width=6cm]{EvacTime/Lattice-EvacTime}\label{fig:LatticeEvacTime}}
\subfloat[]{\includegraphics[width=6cm]{EvacTime/SocialForce-EvacTime}\label{fig:SocialForceEvacTime}}
\subfloat[]{\includegraphics[width=6cm]{EvacTime/RVO2-EvacTime}\label{fig:RVO2EvacTime}}
...
\begin{figure*}[htbp]
\subfloat[]{\includegraphics[width=6cm]{ZoningEvac/Lattice1-1000-ZoningEvac}\label{fig:LatticeZoningEvac1000}}
\subfloat[]{\includegraphics[width=6cm]{ZoningEvac/SocialForce1-1000-ZoningEvac}\label{fig:SocialForceZoningEvac1000}}
\subfloat[]{\includegraphics[width=6cm]{ZoningEvac/RVO21-1000-ZoningEvac}\label{fig:RVO2ZoningEvac1000}}
...
% Density map
\begin{figure*}[htbp]
\subfloat[]{\includegraphics[width=6cm]{DensityMap/Lattice1-1000DensityMap}\label{fig:LatticeDensityMap}}
\subfloat[]{\includegraphics[width=6cm]{DensityMap/SocialForce1-1000DensityMap}\label{fig:SocialForceDensityMap}}
\subfloat[]{\includegraphics[width=6cm]{DensityMap/RVO21-1000DensityMap}\label{fig:RVO2DensityMap}}
...
\begin{figure*}[htbp]
\subfloat[]{\includegraphics[width=6cm]{TravDist/Lattice-TravDist}\label{fig:LatticeTravDist}}
\subfloat[]{\includegraphics[width=6cm]{TravDist/SocialForce-TravDist}\label{fig:SocialForceTravDist}}
\subfloat[]{\includegraphics[width=6cm]{TravDist/RVO2-TravDist}\label{fig:RVO2TravDist}}
...
% Inconvenience
\begin{figure*}[htbp]
\subfloat[]{\includegraphics[width=6cm]{Incon/Lattice-Incon}\label{fig:LatticeIncon}}
\subfloat[]{\includegraphics[width=6cm]{Incon/SocialForce-Incon}\label{fig:SocialForceIncon}}
\subfloat[]{\includegraphics[width=6cm]{Incon/RVO2-Incon}\label{fig:RVO2Incon}}
...
\subfloat[]{\includegraphics[width=6cm]{FlowRate/Lattice-FlowRate}\label{fig:LatticeFlowRate}}
\subfloat[]{\includegraphics[width=6cm]{FlowRate/SocialForce-FlowRate}\label{fig:SocialForceFlowRate}}
\subfloat[]{\includegraphics[width=6cm]{FlowRate/RVO2-FlowRate}\label{fig:RVO2FlowRate}}
...
\begin{figure}[htbp]
\centering
\includegraphics[scale=0.5]{DistatisFinalDistatisMat1-1000}
